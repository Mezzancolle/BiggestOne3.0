...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USNS_SettingsGameInstanceSS_SaveSettings_Statics::NewProp_NewSettings = { "NewSettings", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SNS_SettingsGameInstanceSS_eventSaveSettings_Parms, NewSettings), Z_Construct_UScriptStruct_FSNS_S_SettingsData, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_NewSettings_MetaData), NewProp_NewSettings_MetaData) }; // 2405993802
...
struct Z_Construct_UClass_USNS_SettingsGameInstanceSS_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_USNS_SettingsGameInstanceSS_GetSettings, "GetSettings" }, // 1554561291
		{ &Z_Construct_UFunction_USNS_SettingsGameInstanceSS_LoadSettings, "LoadSettings" }, // 2807005735
		{ &Z_Construct_UFunction_USNS_SettingsGameInstanceSS_SaveSettings, "SaveSettings" }, // 2644256058
	};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Projects_Unreal_Build_Plugin_SimpleNarrativeSystem_HostProject_Plugins_SimpleNarrativeSystem_Source_SimpleNarrativeSystem_Public_SNS_SettingsGameInstanceSS_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_USNS_SettingsGameInstanceSS, USNS_SettingsGameInstanceSS::StaticClass, TEXT("USNS_SettingsGameInstanceSS"), &Z_Registration_Info_UClass_USNS_SettingsGameInstanceSS, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USNS_SettingsGameInstanceSS), 3028426639U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_Unreal_Build_Plugin_SimpleNarrativeSystem_HostProject_Plugins_SimpleNarrativeSystem_Source_SimpleNarrativeSystem_Public_SNS_SettingsGameInstanceSS_h_741714113(TEXT("/Script/SimpleNarrativeSystem"),
	Z_CompiledInDeferFile_FID_Projects_Unreal_Build_Plugin_SimpleNarrativeSystem_HostProject_Plugins_SimpleNarrativeSystem_Source_SimpleNarrativeSystem_Public_SNS_SettingsGameInstanceSS_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Projects_Unreal_Build_Plugin_SimpleNarrativeSystem_HostProject_Plugins_SimpleNarrativeSystem_Source_SimpleNarrativeSystem_Public_SNS_SettingsGameInstanceSS_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
