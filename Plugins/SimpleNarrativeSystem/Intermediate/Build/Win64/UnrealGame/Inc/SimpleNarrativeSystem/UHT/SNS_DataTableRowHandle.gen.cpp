...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Projects_Unreal_Engine_BiggestOne3_0_Plugins_SimpleNarrativePlugin_Source_SimpleNarrativeSystem_Public_SNS_DataTableRowHandle_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FSNS_DataTableRowHandle::StaticStruct, Z_Construct_UScriptStruct_FSNS_DataTableRowHandle_Statics::NewStructOps, TEXT("SNS_DataTableRowHandle"), &Z_Registration_Info_UScriptStruct_SNS_DataTableRowHandle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSNS_DataTableRowHandle), 2601367340U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_Unreal_Engine_BiggestOne3_0_Plugins_SimpleNarrativePlugin_Source_SimpleNarrativeSystem_Public_SNS_DataTableRowHandle_h_2440871644(TEXT("/Script/SimpleNarrativeSystem"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Projects_Unreal_Engine_BiggestOne3_0_Plugins_SimpleNarrativePlugin_Source_SimpleNarrativeSystem_Public_SNS_DataTableRowHandle_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Projects_Unreal_Engine_BiggestOne3_0_Plugins_SimpleNarrativePlugin_Source_SimpleNarrativeSystem_Public_SNS_DataTableRowHandle_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
